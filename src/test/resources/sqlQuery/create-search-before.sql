...
insert into destination (id, airport_code, airport_name, city_name, timezone, country_name) values (4, 'SVO', 'Шереметьево', 'Москва', '+3', 'Россия') on conflict (id) do nothing;
