...
### Фронтенд
Параллельно с нами есть команда фронтов, которая пишет фронт для наших API, поэтому нам не приходится писать вьюшки. Если есть желание посмотреть, как он выглядит - напишите мне в личку, и я дам доступ в репозиторий с фронтом.
