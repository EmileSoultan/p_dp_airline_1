## Postman
Postman - это стандартный инструмент разработчиков, тестировщиков и даже аналитиков для тестирования API.
С помощью него можно создать запрос, задать нужные заголовки, параметры запроса, тело запроса, все это сохранить и использовать для последующего тестирования приложения.

[Скачать тут](https://www.postman.com/downloads/)

## Импорт данных в Postman

Для удобства в нашем репозитории есть коллекция созданных запросов к нашему приложению. Необходимо импортировать ее себе и ознакомиться. Все необходимые вам запросы можете делать по примеру.

1) Откройте Postman, в верхней левой части окна найдите кнопку Import и нажмите на нее
2) Выберите файл из нашего репозитория **p_dp_airline_1.postman_collection.json**
