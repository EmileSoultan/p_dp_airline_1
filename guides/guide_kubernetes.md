...
Путь запроса пользователя в Kubernetes с минимальной необходимой конфигурацией:
![image](./images/RequestPath.png)
