...
Наш проект автоматически обращается к указанному [URL](http://localhost:8080/v3/api-docs) при сборке, генерирует JSON-файл спецификации OpenAPI.
Это обеспечивает актуальную документацию нашего API.
Сгенерированный файл необходимо импортировать в ваш Postman, чтобы сгенерировать коллекцию запросов к нашему приложению.
